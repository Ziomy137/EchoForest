...
- [x] Create 4 new tile sprites (Artist):
...
- [x] Build `Scene_ForestPath.tscn` — 35×50 tile grid (taller than wide — north-south corridor):
...
- [x] Transition zones: south → Farm, north → City outskirts
- [x] Run palette validation against all new sprites (`tools/generate_s803_assets.py`)
